...
def show_images(path_input, path_output='output.png'):
	...
	if len(path_input) > 0:
		...
		if not initiated:
			...
			panelA.place(x=int(1166/2)-200, y=title_size+50)
...
if __name__=="__main__":
	...
	result_label = Label(text="Result: no image selected", bg=bg_color, fg="black",
								font=("yu gothic ui", 17, "bold"), justify="center")
	result_label.place(x=int(1166/2 - 125), y=title_size+0)	
	...
	time_card.place(x=235, y=title_size+475)
	...
	classification_card.place(x=1166-500, y=title_size+475)
	...
	loading_label = Label(text="0.0000 seconds", bg=bg_color, fg="black",
								font=("yu gothic ui", 17, "bold"), justify="center")
	loading_label.place(x=300, y=title_size+480)

	clf_label = Label(text="no image", bg=bg_color, fg="black",
								font=("yu gothic ui", 17, "bold"), justify="center")
	clf_label.place(x=1166-400, y=title_size+480)
